...
export default class SortingVisualizer extends React.Component{
    ...
    buttonenable(){
        ...
        document.getElementById("arrsz").disabled=false;
    }
    buttonsdis(){
        ...
        document.getElementById("arrsz").disabled=true;
    }
    bubblesort(){
        this.buttonsdis();
        document.getElementById("bubble").disabled=true;
    ...
    onarrsz(value){
        ...
        return(
            ...
            ></input>
            <input  id="arrsz" type="range" min="10" max="100" defaultValue="100" 
            step="1" onChange={(e)=>this.onarrsz(e.target.value)}
            ></input>
            </>
        );
        }
